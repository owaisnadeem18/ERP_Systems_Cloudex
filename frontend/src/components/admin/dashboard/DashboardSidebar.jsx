...
//   const dispatch = useDispatch()
  ...
  return (
    <div className={`transition-all ease-in-out duration-500 flex-none ${menu ? "w-75" : "w-16 md:w-20"} text-white`} >
    <div
      className={`transition-all ease-in-out duration-500 h-dvh fixed  top-0 left-0 bg-linear-to-br from-primary-green via-[#6FB8C9] to-primary-blue ${menu ? "w-75" : "w-16 md:w-20"
        }`} >
      <div className='absolute flex mx-auto top-0 left-0  right-0 bottom-0 my-auto  h-full w-full' >

        <div className={`flex flex-col justify-between transition-all duration-300 ${menu ? "w-75" : "w-16 md:w-20"}`} >
          ...
          <div className='flex flex-col gap-4 h-full' >
            ...
            <div className='logo-div cursor-pointer flex justify-center' onClick={toggleMenu} >
              ...
              <img src={menu ? "https://cloudexpk.com/wp-content/uploads/2024/12/CloudEx-logo-1-1.png" : cloudexSmallLogo} className={`${menu ? "px-4" : "px-0" } pt-6 transition-all ease-in-out duration-500 object-cover w-full `}
                alt="" />
            ...
            <div className="flex-1 px-4 flex flex-col gap-4 justify-evenly py-4 lg:py-6 2xl:py-10">
              ...
              <nav className={`flex-1 flex flex-col gap-3 text-white text-sm font-medium ${menu ? "items-start" : "items-center"}`} >
              ...
              <div className='flex justify-start text-white text-sm font-medium' >
                <div className={`flex items-center rounded-full gap-2 cursor-pointer hover:bg-white/20 transition px-4 py-2 ${!menu && "w-12.5 h-12.5"}`} >
                  <LogOutIcon />
